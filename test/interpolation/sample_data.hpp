...
inline
std::pair<polatory::geometry::points3d, polatory::common::valuesd> sample_numerical_data(polatory::index_t n_points) {
...
inline
std::pair<polatory::geometry::points3d, polatory::common::valuesd> sample_sdf_data(polatory::index_t n_surface_points) {
  using polatory::common::valuesd;
  using polatory::geometry::points3d;
  using polatory::geometry::sphere3d;
  using polatory::point_cloud::distance_filter;
