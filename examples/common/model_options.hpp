...
inline boost::program_options::options_description make_model_options_description(
  ...
  gc3   PSILL RANGE  cov_generalized_cauchy3  -1
  gc5   PSILL RANGE  cov_generalized_cauchy5  -1
  gc7   PSILL RANGE  cov_generalized_cauchy7  -1
  gc9   PSILL RANGE  cov_generalized_cauchy9  -1
