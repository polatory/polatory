...
template <int Dim>
class cov_generalized_cauchy5 final : public covariance_function_base<Dim> {
 public:
 ...
 public:
  ...
  explicit cov_generalized_cauchy5(const std::vector<double>& params) { set_parameters(params); }

  RbfPtr clone() const override { return std::make_unique<cov_generalized_cauchy5>(*this); }
...
POLATORY_DEFINE_RBF(cov_generalized_cauchy5);
