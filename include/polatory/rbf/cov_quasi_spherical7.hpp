...
public:
  ...
  static double evaluate_untransformed(double r, const double *params) {
    ...
    return r < 0.2994221418316404
           ? psill * (1.0 - 1.4611477872802014 * r)
           : psill * 0.2654353119171418 * std::pow(0.7172289521523758 + std::pow(r, 2.0), -3.5);
  }
  ...
  void evaluate_gradient_untransformed(
    ...
    auto c = r < 0.2994221418316404
             ? -psill * 1.4611477872802014 / r
             : -psill * 1.8580471834199928 * std::pow(0.7172289521523758 + std::pow(r, 2.0), -4.5);
    *gradx = c * x;
    *grady = c * y;
    *gradz = c * z;
  }
