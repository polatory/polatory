...
#include "../third_party/ScalFMM/Components/FSimpleLeaf.hpp"
#include "../third_party/ScalFMM/Containers/FOctree.hpp"
#include "../third_party/ScalFMM/Core/FFmmAlgorithmThread.hpp"
...
public:
   fmm_operator(const rbf::rbf_base& rbf, int tree_height, const geometry::bbox3d& bounds)
      : n_points(0)
   {
