...
class FitModelToVariogramCommand : public Command {
  static inline const std::string kDescription = "Fit a model to a variogram";
  static inline const std::string kName = "fit-model-to-variogram";
...
CommandPtr make_fit_model_to_variogram_command() {
  return std::make_unique<FitModelToVariogramCommand>();
}
