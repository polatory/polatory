...
class UniqueCommand : public Command {
  static inline const std::string kDescription = "Remove duplicate points";
  static inline const std::string kName = "unique";
...
CommandPtr make_unique_command() { return std::make_unique<UniqueCommand>(); }
