...
class VariogramCommand : public Command {
  static inline const std::string kDescription = "Compute empirical variograms";
  static inline const std::string kName = "variogram";
...
CommandPtr make_variogram_command() { return std::make_unique<VariogramCommand>(); }
