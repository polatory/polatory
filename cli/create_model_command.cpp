...
class CreateModelCommand : public Command {
  static inline const std::string kDescription = "Create a model file";
  static inline const std::string kName = "create-model";
...
CommandPtr make_create_model_command() { return std::make_unique<CreateModelCommand>(); }
