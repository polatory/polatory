...
class CrossValidateCommand : public Command {
  static inline const std::string kDescription = "Perform cross validation";
  static inline const std::string kName = "cross-validate";
...
CommandPtr make_cross_validate_command() { return std::make_unique<CrossValidateCommand>(); }
